...
class Grid {
    ...
    _rowPatterns = computed(() => this._rows().map(r => r._pattern), ...(ngDevMode ? [{ debugName: "_rowPatterns" }] : []));
...
class GridRow {
    ...
    _cellPatterns = computed(() => this._cells().map(c => c._pattern), ...(ngDevMode ? [{ debugName: "_cellPatterns" }] : []));
    /** The parent grid. */
    _grid = inject(Grid);
    /** The parent grid UI pattern. */
    grid = computed(() => this._grid._pattern, ...(ngDevMode ? [{ debugName: "grid" }] : []));
    /** The host native element. */
    element = computed(() => this._elementRef.nativeElement, ...(ngDevMode ? [{ debugName: "element" }] : []));
...
class GridCell {
    ...
    _widgetPattern = computed(() => this._widgets()?._pattern, ...(ngDevMode ? [{ debugName: "_widgetPattern" }] : []));
    /** The parent row. */
    _row = inject(GridRow);
